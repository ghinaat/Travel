...
@error('judul') is-invalid @enderror" id="judul" placeholder="Berita" name="judul" value="{{old('judul')}}">
                        @error('judul') <span class="textdanger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="berita">Berita</label>
                        <textarea rows="7" class="form-control
@error('berita') is-invalid @enderror" id="berita" name="berita">{{old('berita')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" value="0000-00-00"
                            ...
                            placeholder="Tanggal Upload" name="tgl_post" value="{{old('tgl_post')}}">
...
@error('kategori_berita') is-invalid @enderror" placeholder="Kategori Berita" id="kategori_berita"
                                name="kategori_berita" value="{{old('kategori_berita')}}" arialabel="Kategori Berita"
